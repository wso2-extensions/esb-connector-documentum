...
* under the License.
*/
package org.wso2.carbon.connector.integration.test.documentum;
 ...
 */
public class documentumConnectorIntegrationTest extends ConnectorIntegrationTestBase {
    ...
    @Test(enabled = true, groups = {"wso2.ei"}, description = "documentum test case")
